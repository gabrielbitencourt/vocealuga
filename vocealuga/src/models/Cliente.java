...
public class Cliente {
	...
	public boolean save() throws SQLException {
		...
		// POSSIVEL BUG - MESMO QUANDO A QUERY NAO EXECUTA ELE RETORNA TRUE
		// ARRUMAR - VERIFICAR RETORNO DA FUNCAO statement.execute() E TRATAR OS CASOS LANCANDO SQLException CASO NECESSARIO
		conn.close();
		return true;
	}
