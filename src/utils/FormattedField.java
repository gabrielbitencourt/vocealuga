...
public class FormattedField extends TextField {
    ...
    public FormattedField(String mask) {
        this(mask, '_');
    }

    public FormattedField(String mask, char placeholder) {
    ...
    private void init() {
        ...
        // When FormattedField gains focus caret goes to first placeholder position
